...
theme1 = new Image()
theme1.src = 'Picture/og-theme.png'
theme1.onload = () => console.log('✓ theme1 loaded')
theme1.onerror = () => console.error('✗ theme1 FAILED to load from:', theme1.src)

theme2 = new Image()
theme2.src = 'Picture/og-theme-2.png'
theme2.onload = () => console.log('✓ theme2 loaded')
theme2.onerror = () => console.error('✗ theme2 FAILED to load from:', theme2.src)

frame = 0;
degree = Math.PI/180    
SFX_SCORE.src = 'Picture/audio_sfx_point.wav'
SFX_FLAP.src = 'Picture/audio_sfx_wing.wav'
SFX_COLLISION.src = 'Picture/audio_sfx_hit.wav'
SFX_FALL.src = 'Picture/audio_sfx_die.wav'
SFX_SWOOSH.src = 'Picture/sfx_swooshing.wav'

console.log('All assets paths set. Check if they load correctly.')
...
cvs.addEventListener('click', () => {
    console.log('Click detected! Current gameState:', gameState.current)
...
document.body.addEventListener('keydown', (e) => {
    if (e.keyCode == 32) {
        console.log('Spacebar pressed! Current gameState:', gameState.current)
        if (gameState.current == gameState.getReady) {
            gameState.current = gameState.play
            description.style.visibility = "hidden"
            console.log('Game started!')
